...
import com.projectX.projectX.domain.cafe.service.CafeService;
...
public class CafeRestController {
    ...
    public ResponseDTO<String> createBookCafeInfo() {
        cafeService.createBookCafeInfo();
        return ResponseDTO.res("북카페 정보를 성공적으로 저장하였습니다.");
    }
    ...
    public ResponseDTO<String> createLibraryInfo() {
        libraryService.createLibraryInfo();
    ...
    public ResponseDTO<String> updateLibraryInfo() {
        libraryService.updateLibraryInfo();
